...
public class FilmController {
	...
	public String deleteFilm(@PathVariable(required = true) Long idFilm, Model model) {
		model.addAttribute("film_attribute", filmService.caricaSingoloElemento(idFilm));
		return "/film/delete";
	}

	@PostMapping("/executeDelete/{inputid}")
	public String executeDeleteFilm(@PathVariable(required = true) Long inputid,
			@Valid @ModelAttribute("film_attribute") Film film, BindingResult result,
	...
	public String updateFilm(@PathVariable(required = true) Long idFilm, Model model) {
	...
	@PostMapping("/executeUpdate/{idFilm}")
	public String executeUpdateFilm(@PathVariable(required = true) Long idFilm,
			@Valid @ModelAttribute("film_attribute") Film film, BindingResult result,
			RedirectAttributes redirectAttrs) {

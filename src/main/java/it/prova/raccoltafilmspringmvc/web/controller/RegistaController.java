...
public class RegistaController {
	...
	@PostMapping("/savedel/{inputid}")
	public String saveDelRegista(@PathVariable(required = true) Long inputid,
			@Valid @ModelAttribute("regista_attribute") Regista regista, BindingResult result,
			RedirectAttributes redirectAttrs) {
		regista.setId(inputid);
	...
	public String showRegisti(@PathVariable(required = true) Long idRegista, Model model) {
	...
	public String deleteRegista(@PathVariable(required = true) Long idRegista, Model model) {
		model.addAttribute("regista_attribute", registaService.caricaSingoloElementoConFilms(idRegista));
		return "/regista/delete";
	}

	@GetMapping("/edit/{idRegista}")
	public String updateRegista(@PathVariable(required = true) Long idRegista, Model model) {
		model.addAttribute("regista_attribute", registaService.caricaSingoloElemento(idRegista));
		return "/regista/edit";
	}

	@PostMapping("/exeEdit/{idRegista}")
	public String executeUpdateRegista(@PathVariable(required = true) Long idRegista,
			@Valid @ModelAttribute("regista_attribute") Regista regista, BindingResult result,
			RedirectAttributes redirectAttrs) {
